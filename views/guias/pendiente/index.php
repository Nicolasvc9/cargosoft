...
$ruta = 8;
if (!isset($_GET['guia'])) {
    header("location: guiaPendiente.php");
}
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        <input type="hidden" id="numGuiaPendiente" value="<?= $_GET['guia'] ?>" disabled>
        <?php
            ...
            <div class="content-header w-75 mx-auto">
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <input type="text" id="ciudadUser" value="<?= $_SESSION['caribecargo']['ciudad']; ?>">
            ...
            <div class="container-fluid p-5 mx-auto">
                <div class="row">
                    ...
                    <div class="col-4 form-group">
                        <label class="w-100">
                            # guia
                            <input id="numGuia" class="form-control" value="BOG25005" disabled>
                        </label>
                    </div>
                    ...
                    <div class="col-12 col-md-12 form-group border border-info border-3 rounded" id="productosEspeciales">
                    ...
                    <div class="col-12 col-md-4">
                        <label class="w-100">
                            Flete
                            <input type="text" id="input_flete" class="form-control" placeholder="$">
                        </label>
                    </div>
                    <div class="col-12 col-md-4">
                        <label class="w-100">
                            Val. declarado
                            <input type="text" id="valDeclarado" class="form-control" placeholder="$">
                        </label>
                    </div>
                    ...
                    <div class="col-12 col-md-4">
                        <label class="w-100">
                            % Seguro
                            <input type="text" id="seguroG" class="form-control" placeholder="%">
                        </label>
                    </div>
                    <div class="col-12 col-md-4 form-group">
                        <label class="w-100">
                            Tarifa Combustible
                            <input id="tarifaCombustible" type="text" class="form-control" placeholder="$">
                        </label>
                    </div>
                    <div class="col-12 col-md-4 form-group">
                        <label class="w-100">
                            Valuación
                            <input id="valuacion" type="text" class="form-control" placeholder="$">
                        </label>
                    </div>
                    ...
                    <div class="col-12 col-md-4">
                        <label class="w-100">
                            Val. Seguro
                            <input type="text" id="valSeguro" class="form-control border_primary" placeholder="$">
                        </label>
                    </div>
                    <div class="col-12 col-md-4">
                        <label class="w-100">
                            Val. Envío
                            <input type="text" id="valEnvio" class="form-control border_primary" placeholder="$">
                        </label>
                    </div>
                    <div class="col-12 col-md-4 form-group">
                        <label class="w-100">
                            Valor Combustible
                            <input type="text" id="valorCombustible" class="form-control border_primary" placeholder="$">
                        </label>
                    </div>
                    ...
                    <div class="col-12 col-md-6 form-group border border-danger rounded-2 bg-white py-2">
                        <label class="w-100">
                            TOTAL
                            <input id="valorTotal" type="text" class="form-control text-danger fw-bolder" value="$0.0" readonly>
                        </label>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <input type="file" id="imagenes" name="imagenes[]" multiple accept=".jpg, .png">
                        </div>
                        <div class="col-12">

                        </div>
                    </div>
                    <button type="button" id="btnGuardarImg" class="btn btn-primary">boton</button>
                </div>
    ...
    ?>
    <script src="/js/functions_g_pendientes.js"></script>
</body>
